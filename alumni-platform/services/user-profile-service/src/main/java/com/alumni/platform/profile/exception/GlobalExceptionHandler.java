...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleProfileApiException(ProfileApiException ex, HttpServletRequest request) {
        log.warn("Profile API Exception: {} - {}", ex.getCode(), ex.getMessage());
